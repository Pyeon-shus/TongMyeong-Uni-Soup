...
async def on_message(message):
    ...
    if message.content.startswith('!학식'):
        ...
        #user = message.mentions[0] # '!학식' 에서 유저정보를 user에 담는다.
        await channel.send("{} | {} 님이 '!학식'을 입력하셨습니다.".format(message.mentions[0].author, message.mentions[0].mention)) # 작성된 채널에 메세지를 출력한다.
